...
4. **Grade bands:** 정확 (spot-on) · 근접 (close) · 빗나감 (off) — never bare 정답/오답.
...
| 팟 / 벳 (sizing) | pot / bet | noun | Hangul, unit `bb` Latin lowercase |
| 보드 | board | noun | Hangul |
| 핸드 | hand | noun | Hangul; 내 핸드 · HERO, 상대 · VILLAIN card-zone labels |
